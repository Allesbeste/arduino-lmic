...
- [Arduino-LMIC library ("MCCI LoRaWAN LMIC Library")](#arduino-lmic-library-mcci-lorawan-lmic-library)
  ...
  - [Manual configuration](#manual-configuration)
    ...
    - [Pin mapping](#pin-mapping)
      ...
      - [HalConfiguration\_t methods](#halconfiguration_t-methods)
...
library what pin you used through the pin mapping (see [below](#pin-mapping)). For boards with multiple SPI interfaces, the other SPI pins (SCK, MISO, MOSI) can be specified through the pin mapping as well.
...
```c++
  lmic_pinmap lmic_pins = {
    ...
    .spi_freq = 0,
    // optional: specify SPI pins if needed
    .sck = 10,
    .miso = 19,
    .mosi = 27
  };
